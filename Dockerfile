...
ENV WGNAME wg0
ENV ip_list "8 18 28 38 48 58 68 78 88 98"
ENV mtu 1420
ENV PASSWORD pwd
...
RUN apt update \
 && apt install -y --no-install-recommends wireguard-tools iptables nano net-tools wget tar apt-utils ca-certificates curl iperf3 socat \
 && apt clean \
